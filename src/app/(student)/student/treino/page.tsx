...
export default function StudentWorkoutPage() {
  ...
  const workoutDays = trainingSheet?.workouts ? sortDays(Object.keys(trainingSheet.workouts).filter(day => trainingSheet.workouts[day as DayOfWeek]?.length > 0) as DayOfWeek[]) : [];
      ...
      <Card className="shadow-lg mt-8">
        ...
        <CardContent className="space-y-6">
            {workoutDays.length > 0 ? (
                <Tabs defaultValue={workoutDays[0]} className="w-full">
